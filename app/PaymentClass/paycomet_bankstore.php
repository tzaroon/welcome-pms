...
class Paycomet_Bankstore
{
	...
	* Failing that, the card input method for PCI-DSS compliance must be AddUserUrl or AddUserToken (method used by BankStore JET)
	* @param int $ pan Card number, no spaces or hyphens
	* @param string $ expdate Expiration date of the card, expressed as "mmyy" (month in two figures and year in two figures)
	* @param string $ cvv CVC2 code of the card
	* @return object Operation response object
	* @version 2.0 2016-06-02
	*/
	...
	* Create a response from the PAYCOMET BankStore service on object
	* @param array $ response Array of the response to be converted to an object
	* @return object Response object. The RESULT value is included (OK for correct and KO incorrect)
	* @version 1.0 2016-06-03
	*/
	...
	* Check if the URL generated with the desired operation generates an error
	* @param string $ request The URL with the request to PAYCOMET.
	* @return array $ response Array with the response. If there is an error it returns the error it has generated, if it is OK the value DS_ERROR_ID will go to 0.
	* @version 1.0 2016-06-06
	*/
