...
<div class="container" style="max-width: 100% !important;">
    ...
    <form action='/web-check-in/{{$data["bookingCode"]}}/add-guest-details' method="post" enctype="multipart/form-data" id="form">
    @csrf
    <input type="hidden" name="guestId" id="guestId" value="{{$data['guestId']}}">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="ESCANER" role="tabpanel" aria-labelledby="ESCANER-tab">
                    ...
                    <div class="row">
                        ...
                        <!-- <label style="" for="facingModeSelectId">facingMode</label> -->
                            <select style="display:none" class="btn btn-success" style=""id="facingModeSelectId" name="facingMode">
                            <option style="display:none"value="ENVIRONMENT" selected="selected">Back Side</option>
                            <option style="display:none"value="USER">Front Side</option>
                            </select>
                    ...
                    <div class="inner_body text-center">
                        @if ($data['guests']['id_image'] == null)
                        <img src="assets/img/scanner.jpg" class="scanner_image" >
                        @else
                        <img src="{{$data['guests']['id_image']}}" class="scanner_image" >
                        @endif
                    </div>
                ...
                <div class="tab-pane fade" id="DATOS" role="tabpanel" aria-labelledby="DATOS-tab">
                    <div class="row form-group">
                        ...
                        @if ($data['guests']['id_image'] == null)
                        @else
                        <img required id="datosImage" style="width: 300px; height:300px;" src="{{$data['guests']['id_image']}}">
                        @endif
                        <img required style="display:none; width: 300px; height:300px;" class="float-start showImage me-2 document_image" id="imgId">

                        </div> 
                        <input required type="hidden" name="image" id="imageValue" value="{{$data['guests']['id_image']}}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="first_name" class=" input" value="{{$data['guestUser']['first_name']}}">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="last_name" class=" input" value="{{$data['guestUser']['last_name']}}">
                        </div>
                    </div>				
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <select required name="doc_type" class="input">
                                <option value="{{$data['guests']['identification']}}" selected>{{$data['guests']['identification']}}</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="doc_id" value="{{$data['guests']['identification_number']}}" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="date" name="date_of_issue" value="{{$data['guests']['id_issue_date']}}" class="date_expedition date" id="date_expedition">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="date" name="date_of_expiry" value="{{$data['guests']['id_expiry_date']}}" class="date_expiration date" id="date_expiration">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <select required name="gender" class="input" id="gender">
                                <option value="{{$data['guestUser']['gender']}}" selected>{{$data['guestUser']['gender']}}</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required  type="date" name="date_of_birth" value="{{$data['guestUser']['birth_date']}}" class="date_of_birth date" id="date_of_birth">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="tel" name="phone_number" value="{{$data['guestUser']['phone_number']}}" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="email" name="email" value="{{$data['guestUser']['email']}}" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <select required id="country" name="countryId" class="input">
                                <option value="{{$data['guestCountry']['id']}}" selected>{{$data['guestCountry']['name']}}</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <select required name="stateId" id="state"class="input">
                                <option value="{{$data['guestState']['id']}}" selected>{{$data['guestState']['name']}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="zipcode" value="{{$data['guestUser']['postal_code']}}" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-5 col-sm-5 col-5 text-right"><label>Rooms</label></div>
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <select required id="room" name="roomId" class="input">
                            @foreach($data['rooms'] as $room)
                            <option <?php if($data['guestRoomName']['id'] == $room->id){?>  selected="selected" <?php } ?> value="{{$room->id}}"> {{$room->name}}</option>
                            @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="inner_body text-center">
                        ...
                        <div class="row">
                            <div  id="divId">
                                ...
                                @if ($data['guests']['guest_selfie'] == null)
                                @else
                                <img required class="text-center" id="selfieImage" style="width: 300px; height:300px;" src="{{$data['guests']['guest_selfie']}}">
                                @endif
                                <img required style="display:none; width: 300px; height:300px;" class=" showImage me-2" id="imgId01">

                                </div> 
                                <input required type="hidden" name="guest_selfie" id="imageValue01" value="{{$data['guests']['guest_selfie']}}">
                            </div>
                        </div>
                        <!-- end camera -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="signature_main text-center">
                                <span <?php if($data['guests']['guest_signature'] != null){ } else{ ?> style="display:none;" <?php }?> required class="text-center">Your Current Signature: </span><br>
                                <img <?php if($data['guests']['guest_signature'] != null){?>  style="display:inline_block;width:300px;height:150px;border:1px solid silver;margin-bottom:3rem;" <?php } else{ ?> style="display:none;" <?php }?> required class="text-center" id="signImage" style="width: 300px; height:300px;" src="{{$data['guests']['guest_signature']}}"><br>
                                ...
                                <div class="text-center">
                                    ...
                                    <input type="hidden" name="guest_signature" id="imageValue02" value="{{$data['guests']['guest_signature']}}">
                                </div>
                            </div>
                            <div class="text-center">
