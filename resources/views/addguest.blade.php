            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="DATOS" role="tabpanel" aria-labelledby="DATOS-tab">
                    <div class="row form-group">
                        ...
                        <img required style="display:none; width: 300px; height:300px;" class="float-start showImage" id="imgId">
                        </div> 
                        <input required type="hidden" name="image" id="imageValue" value="">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="first_name" class=" input" value="">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="last_name" class=" input" value="">
                        </div>
                    </div>				
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="doc_id" value="" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="date" name="date_of_issue" value="" class="date_expedition date" id="date_expedition">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="date" name="date_of_expiry" value="" class="date_expiration date" id="date_expiration">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required  type="date" name="date_of_birth" value="" class="date_of_birth date" id="date_of_birth">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="tel" name="phone_number" value="" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="email" name="email" value="" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-1"></div>
                        <div class="col-md-6 col-sm-6 col-5">
                            <input required type="text" name="zipcode" value="" class=" input">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="inner_body text-center">
                        ...
                        <div class="row">
                            <div  id="divId">
                                ...
                                <div class="text-center">
                                <video required class="showImage  me-2" style="display:none; width: 300px; height:300px;" id="videoId01" autoplay="true" playsInline></video>                                
                                <img required style="display:none; width: 300px; height:300px;" class=" showImage me-2" id="imgId01">

                                </div> 
                                <input required type="hidden" name="guest_selfie" id="imageValue01" value="">
                            </div>
                        </div>
                        <!-- end camera -->
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="signature_main text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <input type="hidden" name="guest_signature" id="imageValue02" value="">
                                </div>
                            </div>
                            <div class="text-center">
