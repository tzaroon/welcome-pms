...
<body style="background-color: #0bb7af; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td bgcolor="" style=" padding-top:30px;background-color: #0bb7af ;" align="center">
        ...
        <tr>
            <td align="center" style="    background-color: #0bb7af; padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Booking Confirmation!</h1> 
                            <img src="https://blog.clickdimensions.com/wp-content/uploads/2016/11/BlogFeatureImage-5-Tips-for-Effective-Direct-Mail.png" width="250px" height="125px"  />
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">We have received a booking from you - 
                            <b>{{$data['first_name']}} {{$data['last_name']}}</b> 
                            with email address 
                            <b>{{$data['email']}}</b>
                                <br><br>Here is the confirmation:-</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;color:#0bb7af;">© 2021 PMS Chicstays. All rights reserved.</p>
                        </td>
                    </tr>
                </table>
            </td>
